...
describe('SignUp Controller', () => {
  ...
  test('Should  retunr 400 if  no password confirmation is provided', () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should  retunr 400 if  password confirmation fails', () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should  retunr 400 if  an invalid email is provided', () => {
  ...
  test('Should  return 500 if EmailValidados throws', () => {
  ...
  test('Should  retunr 200 if valid data is provided', () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
